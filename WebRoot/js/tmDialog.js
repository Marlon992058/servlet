function tm_dialoag(options){
	...
	"		<p class='bcoma'>"+
	"			<a style='text-decoration:none;font-size:16px;' href='javascript:void(0);' class='bc_abut1 sure'>"+opts.sureText+"</a>"+
	"			<a style='text-decoration:none;font-size:16px;' href='javascript:void(0);' class='bc_abut2 close'>"+opts.cancleText+"</a>"+
	"		</p>"+
	"	</div>"+
